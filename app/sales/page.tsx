...
import pos_main_img from "../../public/solutions_sales.webp"
...
const Sales = () => {
    ...
    return (
        <section>
            <div className=" bg-sales_bg bg-cover bg-no-repeat bg-center w-full aspect-square h-[40vh] md:h-[60vh]">
                <Header />
                <WhatsApp />
                ...
                <div className="one grid grid-cols-12 rounded-3xl text-center ">
                    {SalesRight.map((item, index) => (
                        <div key={index} className="col-span-12 md:col-span-6 lg:col-span-4 border  shadow-[0_3px_20px_1px_rgba(0,0,0,0.10)] p-3 m-6 rounded-3xl *:!leading-[2.5] ">
                            <h3 className="text-lg md:text-xl lg:text-2xl font-semibold text-primary-green ">{item.text} </h3>
